      ...
      <div className="container mx-auto px-6 py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">Access and annotate your PDF documents</p>
          </div>
        ...
        {pdfs.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-2">No PDFs found</h3>
            <p className="text-gray-600">Upload your first PDF to get started</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {pdfs.map((pdf) => (
              <Link key={pdf.id} to={`/pdf-annotate/${pdf.id}`} className="block">
                <div className="group cursor-pointer bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100 overflow-hidden">
                  <PdfThumbnail pdfUrl={pdf.url} pageNumber={1} width={300} />
                  <div className="p-4">
                    <h3 className="font-medium text-gray-800 text-sm leading-tight line-clamp-2 group-hover:text-blue-600 transition-colors">
                      {pdf.name}
                    </h3>
